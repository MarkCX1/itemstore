...
itemstore.config.MaxStack = 9999
...
itemstore.config.SaveInterval = 120
...
itemstore.config.Colours = {
	...
	[ "TitleBackground" ] = Color( 20, 20, 20, 255 ),
	[ "Upper" ] = Color( 10, 10, 10 ),
	[ "Lower" ] = Color( 10, 10, 10 ),
	[ "InnerBorder" ] = Color( 100, 100, 100 ),
	[ "OuterBorder" ] = Color( 0, 0, 0 )
}
...
itemstore.config.HighlightStyle = "border"
...
itemstore.config.DisabledItems = {
	...
	[ "durgz_weed" ] = false,
	[ "prop_physics" ] = true,
	[ "c_wepprocessor" ] = false,
	[ "c_dumpster" ] = false,
	[ "c_money_printer" ] = false,
	[ "rdmportal" ] = false,
	[ "rdmwall" ] = false,
	[ "c_mayor_screen" ] = false,
	[ "tree" ] = false,
	[ "rock" ] = false,
	[ "c_uraniumvein" ] = false,
	[ "pdscreen" ] = false,
	[ "bc_pdscreen" ] = false,
	[ "vip_seller" ] = false,
	[ "c_craftingtable" ] = false,
	[ "c_scrapbuyernpc" ] = false,
	[ "c_tree" ] = false,
	[ "c_rock" ] = false,
	[ "c_crusher" ] = false,
	[ "c_chemhose" ] = false,
	[ "npc_staffapp" ] = false,
	[ "gmt_instrument_piano" ] = false,
	[ "itemstore_bank" ] = false,
}
...
itemstore.config.CustomItems = {
	...
	c_metal = { "Metal Ore", "chunk o metal", true },
	c_scrap = { "Scrap Metal", "Scraps", true },
	c_wood = { "Wood plank", "Giant plank", true },
	c_uraniumore = { "Uranium Ore", "gives radiation", true },
	c_chembarrelempty = { "Empty Chemical Barrel", "full of chemicals", true },
	c_chembarrelfull = { "Full Chemical Barrel", "empty of chemical things", true },
	c_health_pack = { "Health Pack", "health things", true },
	c_wepprocessor_upgrade = { "Processor Upgrade", "processor upgrading things", true },
	c_printer_battery = { "Processor Battery", "processor upgrading things", true },
	c_printer_failsafe = { "Processor Failsafe", "processor upgrading things", true },
}
